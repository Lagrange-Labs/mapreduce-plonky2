...
mod tests {
    ...
    fn test_results_tree_without_duplicates_circuit(is_stored_in_leaf: bool) {
    ...
    #[test]
    fn test_results_tree_without_duplicates_circuit_storing_in_leaf() {
        test_results_tree_without_duplicates_circuit(true);
    }
    #[test]
    fn test_results_tree_without_duplicates_circuit_storing_in_inter() {
        test_results_tree_without_duplicates_circuit(false);
    }
}
