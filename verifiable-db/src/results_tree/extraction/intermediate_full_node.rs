...
//     use crate::results_tree::extraction::PI_LEN;
...
//     #[derive(Clone, Debug)]
//     struct TestIntermediateFullNodeCircuit<'a> {
//         c: IntermediateFullNodeCircuit<MAX_NUM_RESULTS>,
//         subtree_proof: &'a [F],
//         left_child_proof: &'a [F],
//         right_child_proof: &'a [F],
//     }

//     impl<'a> UserCircuit<F, D> for TestIntermediateFullNodeCircuit<'a> {
...
//             let wires = IntermediateFullNodeCircuit::build(
//                 b,
//                 &subtree_pi,
...
//     fn test_intermediate_full_node_circuit(
